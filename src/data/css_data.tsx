  ...
  "color": {
    ...
    "values_description": {
      ...
      "#00FF00": "Sets the text color to green using hexadecimal color notation.",
      "rgb(255, 0, 0)": "Sets the text color to red using RGB color notation."
    }
  },
  "font-size": {
    "property_name": "font-size",
    "value_types": ["<absolute-size>", "<relative-size>", "<length>", "<percentage>"],
    "values_description": {
      "12px": "Sets the font size to 12 pixels.",
      "1.5em": "Sets the font size to 1.5 times the size of the parent element's font size."
    }
  },
  "text-align": {
    ...
    "values_description": {
      ...
      "justify": "Aligns text content to both the left and right edges, adding extra space between words as necessary to justify the text."
    }
  },
  "background-color": {
    ...
    "values_description": {
      ...
      "rgba(255, 0, 0, 0.5)": "Sets the background color to red with 50% transparency."
    }
  }
}
, {
  ...
  "display": {
    ...
    "values_description": {
      ...
      "inline-block": "The element generates a block-level box that participates in a block formatting context.",
  ...
  "font-family": {
    ...
    "values_description": {
      "'Times New Roman', Times, serif": "Specifies a specific font family and fallback generic family.",
      "Arial, sans-serif": "Specifies a specific font family and fallback generic family."
    }
  },
  "font-style": {
...
,{
  ...
  "line-height": {
    ...
    "values_description": {
      ...
      "<percentage>": "Defines the line height as a percentage of the font size."
    }
  },
  "list-style": {
...
,{
  ...
  "max-height": {
    ...
    "values_description": {
      ...
      "<percentage>": "Defines the maximum height as a percentage of the containing block's height."
    }
  },
  "max-width": {
  ...
  "min-width": {
    ...
    "values_description": {
      ...
      "<percentage>": "Defines the minimum width as a percentage of the containing block's width."
    }
  }
}
, {
  "opacity": {
    ...
    "value_types": ["<number>"],
    "values_description": {
      "<number>": "Specifies the opacity level. A value between 0 (fully transparent) and 1 (fully opaque)."
    }
  },
  "overflow": {
    ...
    "values_description": {
      ...
      "scroll": "Content is clipped and a scrollbar is added to see the rest of the content.",
  ...
  "padding": {
    ...
    "values_description": {
      ...
      "<percentage>": "Defines the padding as a percentage of the width of the containing block."
    }
  },
  "position": {
...
, {
  ...
  "vertical-align": {
    ...
    "value_types": ["baseline", "sub", "super", "top", "text-top", "middle", "bottom", "text-bottom"],
    "values_description": {
  ...
  "visibility": {
    ...
    "values_description": {
      ...
      "collapse": "For table rows, the row element will be hidden and the space it occupied will be collapsed."
    }
  },
  "white-space": {
    ...
    "values_description": {
      ...
      "pre-line": "Whitespace is preserved, text wraps when necessary, and line breaks are preserved."
    }
  },
  "width": {
    "property_name": "width",
...
, {
  ...
  "flex": {
    "property_name": "flex",
    "value_types": ["none", "auto", "<flex-grow>", "<flex-shrink>", "<flex-basis>"],
    "values_description": {
      "none": "The item is not flexible.",
      "auto": "The item is flexible.",
      "<flex-grow>": "Defines the flexibility of the item along the main axis.",
      "<flex-shrink>": "Defines the flexibility of the item along the cross axis.",
      "<flex-basis>": "Defines the initial main size of the item before any flexible lengths or factors are applied."
    }
  }
}
, {
  "flex-direction": {
    ...
    "values_description": {
      ...
      "row-reverse": "The main axis is horizontal, and items flow from right to left.",
      "column": "The main axis is vertical, and items flow from top to bottom.",
      "column-reverse": "The main axis is vertical, and items flow from bottom to top."
    }
  },
  "flex-wrap": {
    ...
    "values_description": {
      ...
      "wrap-reverse": "Items wrap onto multiple lines in reverse order if needed."
    }
  },
  "align-items": {
  ...
  "align-self": {
    ...
    "value_types": ["auto", "stretch", "flex-start", "flex-end", "center", "baseline"],
    "values_description": {
      ...
      "baseline": "The item is aligned such that its baseline aligns with the baseline of its parent."
    }
  },
  "justify-content": {
    "property_name": "justify-content",
    "value_types": ["flex-start", "flex-end", "center", "space-between", "space-around"],
    "values_description": {
...
, {
  "animation": {
    ...
    "value_types": ["<animation-name>", "<animation-duration>", "<animation-timing-function>", "<animation-delay>", "<animation-iteration-count>", "<animation-direction>", "<animation-fill-mode>", "<animation-play-state>"],
    "values_description": {
  ...
  "cursor": {
    ...
    "value_types": ["auto", "default", "pointer", "text", "move", "wait", "help", "progress", "crosshair", "alias", "copy", "not-allowed"],
    "values_description": {
      ...
      "crosshair": "The cursor is a crosshair, often used for precision selection.",
...
, {
  "pointer-events": {
    ...
    "value_types": ["auto", "none", "visiblePainted", "visibleFill", "visibleStroke", "visible", "painted", "fill", "stroke", "all"],
    "values_description": {
      ...
      "visiblePainted": "The element reacts to pointer events if it is a descendant of a visible and painted element.",
      "visibleFill": "The element reacts to pointer events if it is a descendant of a visible and fill element.",
      "visibleStroke": "The element reacts to pointer events if it is a descendant of a visible and stroke element.",
      "visible": "The element reacts to pointer events if it is a descendant of a visible element.",
      "painted": "The element reacts to pointer events if it is a descendant of a painted element.",
      "fill": "The element reacts to pointer events if it is a descendant of a fill element.",
      "stroke": "The element reacts to pointer events if it is a descendant of a stroke element.",
  ...
  "text-overflow": {
    ...
    "values_description": {
      ...
      "ellipsis": "Text that overflows the container is truncated with an ellipsis."
    }
  },
  "transform": {
  ...
  "transition": {
    ...
    "value_types": ["<single-transition-property>", "<transition-duration>", "<transition-timing-function>", "<transition-delay>"],
    "values_description": {
      "<single-transition-property>": "Specifies the CSS property to transition.",
      "<transition-duration>": "Specifies the duration of the transition.",
      "<transition-timing-function>": "Specifies the timing function for the transition.",
...
},
 {
  "user-select": {
    ...
    "values_description": {
      ...
      "contain": "Text selection is allowed only if the entire element is selected.",
...
, {
  ...
  "writing-mode": {
    ...
    "values_description": {
      "horizontal-tb": "Text flows horizontally from left to right, then top to bottom.",
      "vertical-rl": "Text flows vertically from top to bottom, then right to left.",
      "vertical-lr": "Text flows vertically from top to bottom, then left to right."
    }
  },
  "z-index": {
    "property_name": "z-index",
...
,{
  "align-content": {
    ...
    "value_types": ["stretch", "center", "flex-start", "flex-end", "space-between", "space-around"],
    "values_description": {
  ...
  "align-self": {
    "property_name": "align-self",
    "value_types": ["auto", "stretch", "center", "flex-start", "flex-end", "baseline"],
    "values_description": {
  ...
  "animation-direction": {
    ...
    "value_types": ["normal", "reverse", "alternate", "alternate-reverse", "initial", "inherit"],
    "values_description": {
      "normal": "The animation plays forward each cycle.",
      "reverse": "The animation plays backward each cycle.",
      "alternate": "The animation plays forward on even cycles and backward on odd cycles.",
      "alternate-reverse": "The animation plays backward on even cycles and forward on odd cycles.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  }
...
, {
  "animation-timing-function": {
    ...
    "value_types": ["ease", "linear", "ease-in", "ease-out", "ease-in-out", "cubic-bezier(<number>, <number>, <number>, <number>)", "initial", "inherit"],
    "values_description": {
      ...
      "cubic-bezier(<number>, <number>, <number>, <number>)": "Specifies a cubic Bezier curve for the transition.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  ...
  "background": {
    ...
    "value_types": ["<background-color>", "<background-image>", "<background-repeat>", "<background-attachment>", "<background-position>", "<background-size>", "<background-origin>", "<background-clip>", "<background-blend-mode>", "initial", "inherit"],
    "values_description": {
      ...
      "<background-position>": "Specifies the starting position of the background image(s).",
      "<background-size>": "Specifies the size of the background image(s).",
      "<background-origin>": "Specifies the positioning area of the background images.",
      "<background-clip>": "Specifies the painting area of the background images.",
      "<background-blend-mode>": "Specifies the blending mode of the background images.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  "background-attachment": {
    ...
    "values_description": {
      ...
      "local": "The background image is fixed relative to the element's contents.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  "background-blend-mode": {
    ...
    "value_types": ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity", "initial", "inherit"],
    "values_description": {
      "normal": "Default value. Specifies no blending.",
      "multiply": "Multiplies the colors of the background and the background layers.",
      ...
      "saturation": "Uses the saturation of the source color with the hue and luminosity of the backdrop color.",
      "color": "Uses the color of the source color with the hue and saturation of the backdrop color.",
      "luminosity": "Uses the luminosity of the source color with the hue and saturation of the backdrop color.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  }
...
, {
  ...
  "background-origin": {
    ...
    "value_types": ["padding-box", "border-box", "content-box", "initial", "inherit"],
    "values_description": {
  ...
  "background-position": {
    ...
    "value_types": ["<position>", "left top", "left center", "left bottom", "right top", "right center", "right bottom", "center top", "center center", "center bottom", "x% y%", "initial", "inherit"],
    "values_description": {
      "<position>": "Specifies the horizontal and vertical position of the background image.",
      "left top": "Positions the background image in the top-left corner.",
      "left center": "Positions the background image in the center of the left edge.",
      "left bottom": "Positions the background image in the bottom-left corner.",
      "right top": "Positions the background image in the top-right corner.",
      "right center": "Positions the background image in the center of the right edge.",
      "right bottom": "Positions the background image in the bottom-right corner.",
      "center top": "Positions the background image in the center of the top edge.",
      "center center": "Positions the background image in the center of the element.",
      "center bottom": "Positions the background image in the center of the bottom edge.",
      "x% y%": "Specifies the position as a percentage of the element's width and height.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  "background-repeat": {
    ...
    "value_types": ["repeat", "repeat-x", "repeat-y", "no-repeat", "initial", "inherit"],
    "values_description": {
...
, {
  "border-bottom-style": {
    ...
    "values_description": {
      ...
      "outset": "The border makes the box look like it is coming out of the page.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  ...
  "border-image": {
    ...
    "value_types": ["<image-source>", "<image-slice>", "<image-width>", "<image-outset>", "<image-repeat>", "initial", "inherit"],
    "values_description": {
      "<image-source>": "Specifies the path to the image to be used as the border.",
      "<image-slice>": "Specifies how to slice the image to use for the borders.",
      "<image-width>": "Specifies the width of the border image.",
      "<image-outset>": "Specifies the amount by which the border image area extends beyond the border box.",
      "<image-repeat>": "Specifies how the image should be repeated to fill the border area.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  }
...
, {
  "border-image-outset": {
    ...
    "values_description": {
      "<length>": "Specifies the amount by which the border image area extends beyond the border box.",
      "<number>": "Specifies a multiplication factor to enlarge or shrink the border image area.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  "border-image-repeat": {
    ...
    "value_types": ["stretch", "repeat", "round", "space", "initial", "inherit"],
    "values_description": {
      "stretch": "The border image is stretched to fill the entire border area.",
      "repeat": "The border image is repeated to fill the entire border area.",
      "round": "The border image is repeated and stretched to fill the entire border area without clipping.",
      "space": "The border image is repeated and spaced out to fill the entire border area without clipping.",
      "initial": "Sets the property to its default value.",
      "inherit": "Inherits the value from its parent element."
    }
  },
  "border-image-slice": {
    ...
    "values_description": {
      "<number>": "Specifies the size of the inward offsets from the top, right, bottom, and left edges of the border image.",
      "<percentage>": "Specifies the size as a percentage of the width or height of the image.",
  ...
  "border-image-width": {
    ...
    "value_types": ["<length>", "<percentage>", "<number>", "auto", "initial", "inherit"],
    "values_description": {
      "<length>": "Specifies the width of the border image.",
      "<percentage>": "Specifies the width as a percentage of the width or height of the image.",
      "<number>": "Specifies a multiplication factor to enlarge or shrink the border image width.",
