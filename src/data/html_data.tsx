export const htmlData   = [
  {
    ...
    "attributes": [
      ...
      },
      {
        ...
        "value_description": "Common values include '_self', '_blank', '_parent', '_top'."
      },
      {
        "name": "download",
        "description": "Indicates that the linked resource should be downloaded rather than displayed.",
        "value_description": "Specifies the filename to be used when downloading."
      },
      {
        "name": "rel",
        "description": "Specifies the relationship between the current document and the linked resource.",
        "value_description": "Common values include 'nofollow', 'noopener', 'noreferrer'."
      },
      {
        "name": "title",
        "description": "Provides additional information about the linked resource.",
        "value_description": "The title text is often displayed as a tooltip on hover."
      }
    ]
  },
  {
    "tag": "abbr",
    "description": "Defines an abbreviation or acronym, typically rendered with a dotted underline to indicate its full form on hover.",
    "attributes": [
      {
        "name": "title",
        "description": "Specifies the full form of the abbreviation or acronym.",
        "value_description": "The full form is often displayed as a tooltip on hover."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      {
        "name": "alt",
        "description": "Provides alternative text for the area, displayed when the image cannot be loaded or for screen readers.",
        "value_description": "Specifies a brief description of the area."
      },
      {
        "name": "coords",
        "description": "Specifies the coordinates of the area.",
        "value_description": "Specifies the shape and size of the area. Format varies based on the shape."
      },
      {
        "name": "href",
        "description": "Specifies the URL of the linked resource.",
  ...
  {
    "tag": "article",
    "description": "Defines an independent, self-contained content/article section within a document.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    "tag": "aside",
    "description": "Defines content aside from the content (such as sidebars) typically related to the surrounding content.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "No value required. The presence of the attribute indicates autoplay."
      },
      {
        "name": "controls",
        "description": "Specifies that audio controls (such as play, pause, volume) should be displayed.",
        "value_description": "No value required. The presence of the attribute indicates controls."
      },
      {
        "name": "loop",
        "description": "Specifies that the audio will start over again, every time it is finished.",
        "value_description": "No value required. The presence of the attribute indicates loop."
      },
      {
        "name": "preload",
        "description": "Specifies if and how the audio should be loaded when the page loads.",
    ...
    "attributes": [
      {
        ...
        "value_description": "Specifies the URL to be used as the base for relative URLs."
      }
    ]
  },
  {
    "tag": "bdi",
    "description": "Isolates a portion of text that might be displayed in a different direction from other parts of the content.",
    "attributes": [
      {
        "name": "dir",
        "description": "Specifies the directionality of the text.",
        "value_description": "Common values include 'ltr' (left-to-right) and 'rtl' (right-to-left)."
      }
    ]
  },
  ...
  {
    "tag": "bdo",
    "description": "Overrides the default text direction for the element and any of its descendants.",
    "attributes": [
      {
        "name": "dir",
        "description": "Specifies the directionality of the text.",
  ...
  {
    "tag": "body",
    "description": "Defines the content of an HTML document, excluding the document's metadata.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "No value required. The presence of the attribute indicates disabled."
      },
      {
        "name": "form",
  ...
  {
    "tag": "cite",
    "description": "Defines the title of a creative work, such as a book, movie, or article.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      {
        "name": "span",
        "description": "Specifies the number of columns the <col> element should span.",
  ...
  {
    "tag": "colgroup",
    "description": "Specifies a group of one or more columns in a table for formatting purposes.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  {
    "tag": "dd",
    "description": "Defines a description or value within a description list (<dl>).",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        "name": "cite",
        "description": "Specifies the URL of the document that explains why the text was deleted.",
      ...
      },
      {
        ...
        "value_description": "Specifies the date and time in the format 'YYYY-MM-DDThh:mm:ssTZD'."
      }
    ]
  },
  {
    "tag": "details",
    "description": "Defines additional details or controls that the user can view or interact with.",
    "attributes": [
      {
        "name": "open",
        "description": "Specifies that the details should be visible (open) to the user by default.",
        "value_description": "No value required. The presence of the attribute indicates open."
      }
    ]
  },
  {
  ...
  {
    "tag": "fieldset",
    "description": "Groups related form elements together and defines a set of form controls.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  {
    "tag": "figure",
    "description": "Represents self-contained content, like illustrations, diagrams, photos, or code listings.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "Specifies the URL where the form data will be submitted."
      },
      {
        "name": "method",
        "description": "Specifies the HTTP method to be used when submitting the form.",
        "value_description": "Specifies the HTTP method to be used when submitting the form (e.g., 'get' or 'post')."
      },
      {
        "name": "target",
        "description": "Specifies where to display the response received after submitting the form.",
        "value_description": "Specifies where to display the response received after submitting the form."
      }
    ]
  },
  {
  ...
  {
    "tag": "head",
    "description": "Defines the metadata of the document, including its title and links to external resources.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  {
    "tag": "hr",
    "description": "Defines a thematic break between paragraphs or sections of content.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      {
        "name": "frameborder",
        "description": "Specifies whether to display a border around the inline frame.",
        "value_description": "Specifies whether to display a border around the inline frame."
      }
    ]
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "Specifies the type of input control (e.g., 'text', 'checkbox', 'radio')."
      },
      {
        "name": "name",
      ...
      {
        "name": "placeholder",
        "description": "Specifies a short hint that describes the expected value of the input control.",
        "value_description": "Specifies a short hint that describes the expected value of the input control."
      }
    ]
  },
  {
    ...
    "attributes": [
      {
        "name": "cite",
        "description": "Specifies the URL of the document that explains why the text was inserted.",
        "value_description": "Specifies the URL of the explanation document."
      },
      {
        "name": "datetime",
  ...
  {
    "tag": "label",
    "description": "Defines a label for an <input>, <select>, <textarea>, or <button> element.",
    "attributes": [
      {
        "name": "for",
  ...
  {
    "tag": "li",
    "description": "Defines a list item within an ordered or unordered list (<ol> or <ul>).",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      ...
      },
      {
        "name": "rel",
        "description": "Specifies the relationship between the current document and the linked resource.",
        "value_description": "Specifies the relationship between the current document and the linked resource."
      },
      {
        "name": "type",
      ...
      {
        "name": "media",
        "description": "Specifies the media type for which the linked resource is intended.",
        "value_description": "Specifies the media type for which the linked resource is intended."
      },
      {
        "name": "hreflang",
      ...
      {
        "name": "sizes",
        "description": "Specifies the sizes of the icons for the linked resource.",
        "value_description": "Specifies the sizes of the icons for the linked resource."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      },
      {
        ...
        "value_description": "Specifies the minimum value of the measurement range."
      },
      {
        "name": "max",
        "description": "Specifies the maximum value of the measurement range.",
        "value_description": "Specifies the maximum value of the measurement range."
      },
      {
        "name": "low",
  ...
  {
    "tag": "noscript",
    "description": "Defines alternate content to be displayed for users whose browsers do not support JavaScript.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    "tag": "object",
    "description": "Defines an embedded object, such as an image, audio, video, Java applet, or Flash animation.",
    "attributes": [
      {
        "name": "data",
  ...
  },
  {
    ...
    "attributes": [
      {
        "name": "reversed",
        "description": "Specifies that the list items should be numbered in reverse order.",
        "value_description": "No value required. The presence of the attribute indicates reversed numbering."
      },
      {
        "name": "start",
      ...
      },
      {
        ...
        "value_description": "Specifies the numbering style of the ordered list (e.g., '1', 'A', 'a', 'I', 'i')."
      }
    ]
  },
  {
    "tag": "optgroup",
    "description": "Defines a group of related options within a <select> element.",
    "attributes": [
      {
        "name": "disabled",
  ...
  },
  {
    ...
    "attributes": [
      ...
      {
        "name": "selected",
        "description": "Specifies that the option should be pre-selected when the page loads.",
        "value_description": "No value required. The presence of the attribute indicates pre-selected."
      },
      {
        "name": "value",
  ...
  },
  {
    ...
    "attributes": [
      {
        "name": "for",
        "description": "Specifies the ID of the form element that the output element is associated with.",
        "value_description": "Specifies the ID of the form element."
      },
      {
        "name": "form",
  ...
  {
    "tag": "picture",
    "description": "Defines a container for multiple image sources and their corresponding <source> elements for responsive images.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  {
    "tag": "progress",
    "description": "Defines an element representing the completion progress of a task.",
    "attributes": [
      {
        "name": "value",
  ...
  {
    "tag": "rt",
    "description": "Defines an explanation or pronunciation of characters (for East Asian typography) that are part of a ruby annotation.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    "tag": "ruby",
    "description": "Defines a ruby annotation, used for East Asian typography annotations.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    "tag": "s",
    "description": "Defines text that is no longer correct, relevant, or accurate.",
    "attributes": [],
    "attributes_description": {}
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      {
        "name": "async",
        "description": "Specifies that the script should be executed asynchronously.",
        "value_description": "No value required. The presence of the attribute indicates asynchronous execution."
      },
      {
        "name": "defer",
        "description": "Specifies that the script should be executed after the page has been parsed.",
        "value_description": "No value required. The presence of the attribute indicates deferred execution."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      },
      {
        ...
        "value_description": "No value required. The presence of the attribute indicates multiple selection."
      },
      {
        "name": "size",
        "description": "Specifies the number of visible options in the dropdown list.",
  ...
  {
    "tag": "source",
    "description": "Defines multiple media resources for <video> and <audio> elements.",
    "attributes": [
      {
        "name": "src",
  ...
  {
    "tag": "style",
    "description": "Defines style information for a document or a part of a document.",
    "attributes": [
      {
        "name": "type",
      ...
      {
        "name": "media",
        "description": "Specifies the media type for which the style sheet is intended.",
        "value_description": "Specifies the media type for which the style sheet is intended."
      },
      {
        "name": "scoped",
        "description": "Specifies that the styles only apply to the parent element and its descendants.",
        "value_description": "No value required. The presence of the attribute indicates scoped styling."
      }
    ]
  },
  {
  ...
  {
    "tag": "svg",
    "description": "Defines a container for Scalable Vector Graphics (SVG) content.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "Specifies the number of columns that the cell should span."
      },
      {
        "name": "rowspan",
        "description": "Specifies the number of rows that the cell should span.",
        "value_description": "Specifies the number of rows that the cell should span."
      }
    ]
  },
  {
    "tag": "template",
    "description": "Defines a template that can be used to stamp out new DOM nodes.",
    "attributes": [],
    "attributes_description": {}
  },
  {
    ...
    "attributes": [
      {
        "name": "cols",
        "description": "Specifies the visible width of the text control, in average character widths.",
        "value_description": "Specifies the visible width of the text control."
      },
      {
        "name": "rows",
        "description": "Specifies the visible height of the text control, in lines.",
        "value_description": "Specifies the visible height of the text control."
      },
      {
        "name": "maxlength",
        "description": "Specifies the maximum number of characters that the user can input.",
        "value_description": "Specifies the maximum number of characters."
      },
      {
        "name": "wrap",
        "description": "Specifies how the text in the textarea is to be wrapped when submitted in a form.",
        "value_description": "Specifies how the text in the textarea is to be wrapped."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      {
        "name": "scope",
        "description": "Specifies the set of header cells that the current cell is related to.",
        "value_description": "Specifies the set of header cells that the current cell is related to."
      }
    ]
  },
  {
    ...
    "attributes": [
      {
        ...
        "value_description": "Specifies the date and/or time in the format 'YYYY-MM-DDThh:mm:ssTZD'."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      },
      {
        ...
        "value_description": "Specifies the kind of text track (e.g., 'subtitles', 'captions', 'descriptions')."
      },
      {
        "name": "label",
      ...
      },
      {
        ...
        "value_description": "No value required. The presence of the attribute indicates default."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "attributes": [
      ...
      {
        "name": "autoplay",
        "description": "Specifies that the video should start playing automatically.",
        "value_description": "No value required. The presence of the attribute indicates autoplay."
      },
      {
        "name": "controls",
        "description": "Specifies that video controls should be displayed (play, pause, volume, etc.).",
        "value_description": "No value required. The presence of the attribute indicates controls."
      },
      {
        "name": "loop",
        "description": "Specifies that the video should start over again, every time it is finished.",
        "value_description": "No value required. The presence of the attribute indicates loop."
      },
      {
        "name": "muted",
        "description": "Specifies that the audio output of the video should be muted.",
        "value_description": "No value required. The presence of the attribute indicates muted."
      },
      {
        "name": "poster",
      ...
      {
        "name": "preload",
        "description": "Specifies if and how the video should be loaded when the page loads.",
        "value_description": "Specifies if and how the video should be loaded when the page loads."
      },
      {
        "name": "width",
